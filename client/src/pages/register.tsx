    ...
    try {
      ...
      if (selectedRole === "ambulance") {
        if (!formData.selectedHospitalId) {
          alert(
            "Please select a preferred hospital for ambulance registration",
          );
          return;
        }
      ...
      const registrationData = {
        ...
        ...(selectedRole === "ambulance" && {
          ...
          certification: formData.certification,
          selectedHospitalId: formData.selectedHospitalId
            ? parseInt(formData.selectedHospitalId)
            : undefined,
          equipmentLevel: formData.equipmentLevel,
        }),
      ...
      <Card className="w-full max-w-sm sm:max-w-2xl lg:max-w-4xl xl:max-w-5xl">
        <CardHeader className="text-center p-4 sm:p-6">
          <CardTitle className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 flex items-center justify-center space-x-2">
            ...
            <span>Join EmergencyConnect</span>
          </CardTitle>
        ...
        <CardContent>
          <form
            ...
            className="space-y-6"
            data-version="v3.0-cache-bust-1751955879142"
          >
            {/* Role Selection */}
            ...
            {selectedRole === "ambulance" && (
              <div className="bg-orange-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="selectedHospitalId">
                      Preferred Hospital *
                    </Label>
                    <HospitalSelect
                      value={formData.selectedHospitalId}
                      onValueChange={(value) =>
                        handleInputChange("selectedHospitalId", value)
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("operatorPhone", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Critical Care Transport">
                          Critical Care Transport
                        </SelectItem>
                        <SelectItem value="Neonatal Intensive Care">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleInputChange("equipmentLevel", value)
                      }
                    >
                      <SelectTrigger>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="Level 2">
                          Level 2 - Advanced Equipment
                        </SelectItem>
                        <SelectItem value="Level 3">
                          Level 3 - Critical Care Equipment
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="md:col-span-2 bg-blue-50 p-3 rounded-lg">
                    <p className="text-sm text-blue-700">
                      <strong>Note:</strong> Your ambulance vehicle number and
                      profile will be automatically assigned (e.g., AMB-006)
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("totalBeds", e.target.value)
                        }
                        min="1"
                        required
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("icuBeds", e.target.value)
                        }
                        min="0"
                        required
                      />
